...
function Form() {
  ...
  const {setModelType,modelType,posts,setPosts,model,setModel,post,setPost,setSSR,setHandlePost,handlePost} = useStates();


  const notify = () => toast.success("Post Uploaded",{ 
   position: "top-center",
autoClose: 5000,
...
{loading?<div className='absolute -bottom-5 right-10'><TailSpin color="green" width={30}/></div>: <button
